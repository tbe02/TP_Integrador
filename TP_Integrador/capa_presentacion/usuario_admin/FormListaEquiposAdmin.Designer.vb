...
Partial Class FormListaEquiposAdmin
    ...
    Private Sub InitializeComponent()
        ...
        DGVListaEquipos.Columns.AddRange(New DataGridViewColumn() {C_Cliente, C_DNI, C_TipoEquipo, C_NroSerie, C_Marca, C_Modelo, C_EquipoEnciende, C_EstadoEquipo, C_Baja, C_InfomacionEquipo, C_Editar, C_Eliminar})
