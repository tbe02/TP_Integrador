...
Partial Class FormListaEquiposTecnico
    ...
    Private Sub InitializeComponent()
        ...
        DGVListaEquipos.Columns.AddRange(New DataGridViewColumn() {C_Cliente, C_TipoEquipo, C_NroSerie, C_Marca, C_EquipoEnciende, C_EstadoEquipo, C_InfomacionEquipo, C_Editar})
        ...
        LListaEquipos.Font = New Font("Bahnschrift Condensed", 36.0F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
